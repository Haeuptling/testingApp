...
class TestMeasurementView(unittest.TestCase):
    ...
    def test_update_pressure_chart(self):
        self.measurement_controller.m_measurement.get_pressure_values = MagicMock(return_value=[MagicMock()])
    ...
    def test_update_dewpoint_chart(self):
        self.measurement_controller.m_measurement.get_relative_humidity_values = MagicMock(return_value=[MagicMock()])
